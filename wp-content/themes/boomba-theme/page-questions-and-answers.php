            ...
            <div class="col-md-8 col-xs-12">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xs-12  text-center py-3 py-lg-4">
                        <h2 class="h1 mb-3 h-border-top text-color-5"><?php the_title() ?></h2>
                        <div class="entry-content ">
                            <?php the_content() ?>
                        </div>

                        <div class="accordion panel-group  rounded" id="accordionExample">
                            <?php $counter = 1; ?>
                            <?php while (have_rows('boom_questions-and-answers')): the_row(); ?>
                                <div class="box-shadow-1 rounded mb-3 text-left">
                                    <div class="card">
